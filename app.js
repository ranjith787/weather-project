...
var weatherImages = {
  ...
  "clear-night": "http://getwallpapers.com/wallpaper/full/6/8/8/841916-full-hd-background-images-1920x1080-pictures.jpg",
...
const displayMsg= () => {
  if (weatherSummary == Clear){
    document.getElementById("dispmsg").innerHTML="works";
  }
  else {
    document.getElementById("dispmsg").innerHTML="really works";
  }
}
...
var getWeather = function() {
  ...
  function showWeather(lat, long) {
    var url = `https://api.darksky.net/forecast/1e65ef565312be8b790f2ebdcbb95202/${lat},${long}` + `?format=jsonp&callback=displayWeather`;
...
var object;
 ...
 function displayWeather(object) {
    ...
    weatherSummary.innerHTML =  " Weather: " + object.currently.summary;
